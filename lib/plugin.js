			...
			app.getApplication(CONFIG.req, CONFIG.res)
				.then(function(app)
				{
					...
					app.getHTML(function(content)
					{
						...
						{
							var output = 'SAPPHIRE.loader.loadScripts([\'/sfe/assets/js/Models/Service.js\']);\n';
